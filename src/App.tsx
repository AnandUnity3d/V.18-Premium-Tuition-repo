      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Learn from Karnataka's most qualified and experienced educators who bring subjects to life through innovative AR/VR technology
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-blue-600 font-semibold mb-2">M.Sc Physics, B.Ed</p>
                <p className="text-gray-600 mb-4">Physics & Mathematics Specialist</p>
                <div className="text-sm text-gray-500 space-y-1">
                  <p>• 15+ years teaching experience</p>
                  <p>• Former CBSE examiner</p>
                  <p>• 95% student success rate</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
              <div className="flex flex-col items-center text-center">
                <div className="w-24 h-24 bg-gradient-to-br from-green-500 to-teal-600 rounded-full flex items-center justify-center mb-4">
                  <User className="w-12 h-12 text-white" />
                </div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">Prof. Sunita Patil</h3>
                <p className="text-green-600 font-semibold mb-2">M.Sc Chemistry, Ph.D</p>
                <p className="text-gray-600 mb-4">Chemistry & Biology Expert</p>
                <div className="text-sm text-gray-500 space-y-1">
                  <p>• 12+ years research experience</p>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">Shri Manjunath Gowda</h3>
                <p className="text-orange-600 font-semibold mb-2">M.A Kannada, B.Ed</p>
                <p className="text-gray-600 mb-4">Kannada & Social Science</p>
                <div className="text-sm text-gray-500 space-y-1">
                  <p>• 18+ years teaching experience</p>
                  <p>• State award winner</p>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">Mrs. Priya Sharma</h3>
                <p className="text-purple-600 font-semibold mb-2">M.A English, B.Ed</p>
                <p className="text-gray-600 mb-4">English & Communication</p>
                <div className="text-sm text-gray-500 space-y-1">
                  <p>• 10+ years experience</p>
                  <p>• IELTS certified trainer</p>
                  <p>• Creative writing expert</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
              <div className="flex flex-col items-center text-center">
                <div className="w-24 h-24 bg-gradient-to-br from-indigo-500 to-blue-600 rounded-full flex items-center justify-center mb-4">
                  <User className="w-12 h-12 text-white" />
                </div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">Mr. Arun Desai</h3>
                <p className="text-indigo-600 font-semibold mb-2">M.Sc Mathematics, M.Tech</p>
                <p className="text-gray-600 mb-4">Advanced Mathematics & JEE</p>
                <div className="text-sm text-gray-500 space-y-1">
                  <p>• 14+ years IIT-JEE coaching</p>
                  <p>• 200+ students in top colleges</p>
                  <p>• Problem-solving specialist</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
              <div className="flex flex-col items-center text-center">
                <div className="w-24 h-24 bg-gradient-to-br from-teal-500 to-green-600 rounded-full flex items-center justify-center mb-4">
                  <User className="w-12 h-12 text-white" />
                </div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">Dr. Kavitha Reddy</h3>
                <p className="text-teal-600 font-semibold mb-2">M.Sc Biology, Ph.D</p>
                <p className="text-gray-600 mb-4">Biology & Life Sciences</p>
                <div className="text-sm text-gray-500 space-y-1">
                  <p>• 16+ years medical coaching</p>
                  <p>• NEET success rate 92%</p>
          ...
          <div className="bg-white rounded-2xl max-w-md w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-2xl font-bold text-gray-900">Apply for Admission</h3>
                <button
              ...
              <div className="space-y-4">
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <h4 className="font-semibold text-blue-900 mb-2">📞 Call for Admission</h4>
                  <p className="text-blue-800 text-sm mb-3">Speak directly with our admission counselor</p>
                  <a 
                    href="tel:+918123144616" 
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  <h4 className="font-semibold text-green-900 mb-2">📧 Email Application</h4>
                  <p className="text-green-800 text-sm mb-3">Send your details via email</p>
                  <a 
                    href="mailto:anandbiradar002@gmail.com?subject=Admission Inquiry - V.18 Premium Tuition&body=Hello, I would like to apply for admission. Please find my details below:%0D%0A%0D%0AStudent Name: %0D%0AClass: %0D%0AParent Name: %0D%0APhone Number: %0D%0AAddress: %0D%0A%0D%0AThank you." 
                    className="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition-colors font-medium inline-flex items-center"
                  >
                ...
                <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
                  <h4 className="font-semibold text-orange-900 mb-2">🏫 Visit Our Center</h4>
                  <p className="text-orange-800 text-sm mb-3">Come for a campus visit and demo class</p>
                  <div className="text-orange-800 text-sm">
                    <p className="font-medium">Address:</p>
                    <p>Near Govt High School, Jamkhandi, Karnataka</p>
                  </div>
                </div>

                <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                  <h4 className="font-semibold text-purple-900 mb-2">🎯 Book Free Demo</h4>
                  <p className="text-purple-800 text-sm mb-3">Experience our AR/VR technology firsthand</p>
                  <button 
                    onClick={() => {
